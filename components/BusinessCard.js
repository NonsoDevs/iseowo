      ...
      <div className="flex gap-2">
        <Link href="#">
          <Image
            width={40}
            height={40}
            src="/demo-images/demo-logo.png"
            alt="business logo"
          />
        </Link>
        <Link href="#" className="flex flex-col">
          <span className="text-lg text-lime-800">
            Unified Trading For Water Packaging Limited
          </span>
          <span className="text-xs text-gray-500">Abaji, FCT</span>
        </Link>
      </div>
      <p>
        A variety of reported recipes and experimental recreations have been
        published. The secrecy around the formula has been used bu Coca-Cola as
        a marketing aid because only a handful of anonymoud employees knows the
        formula
      </p>
