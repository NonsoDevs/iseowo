    ...
    <>
      <nav className="h-[60px] w-full flex justify-between items-center px-2 md:px-8 lg:px-16 shadow-md">
        <ul className="flex flex-col lg:flex-row lg:items-center gap-4">
          <li className={`${bebasNeue} text-lg uppercase`}>
            <Link href="/">Iseowo</Link>
          </li>
          <li className="text-md text-gray-800 hidden lg:block">
            <Link href="#">Home</Link>
          </li>
        </ul>
        ...
        <ul className="flex flex-row items-center gap-4">
          <li>
            <Link
              href="#"
              className="text-md text-gray-800 border border-gray-400 py-2 px-3"
            >
              Sign in
            </Link>
          </li>
