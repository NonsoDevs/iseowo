...
export function MyListingCard({ listingId, data }) {
  return (
    <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-4 p-4 border border-lime-600 rounded-sm">
      <div>
      ...
      <Link
        href="#"
        className="h-8 flex justify-center items-centerbg-lime-700 text-white px-2 rounded-sm"
      >
        Visit Listing
      </Link>
    </div>
